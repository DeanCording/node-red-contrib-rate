...
Change the *Rate Period* in the example and examine what happens!
...
```
**Fig. 6:** Timestamp measuring example flow
...
**Fig. 8:** Value measuring example flow
